@extends('admin.tema')
@section('admintitle') Laravel 8 Alpha-GY Duzenleme İşlemleri @endsection
@section('css')
                                ...
                                <div class="basic-form">
                                    <form action="{{route('duzenlePost',[$modulBilgisi->seflink,$veriler->id])}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <select type="text" class="form-control input-default" name="kategori">
                                           @if ($kategoriBilgisi)
                                        ...
                                        <textarea name="metin" class="summernote">{{$veriler->metin}}</textarea>
                                         ...
                                         <label>Resim</label>
                                            ...
                                            <input type="file" class="form-control input-default" placeholder="Resim" name="resim">
                                        </div>
                                        ...
                                        <label>Sıra No</label>
                                            ...
                                            <input type="number" class="form-control input-default" placeholder="Sıra No" name="sirano" value="{{$veriler->sirano}}" required>
                                        </div>
